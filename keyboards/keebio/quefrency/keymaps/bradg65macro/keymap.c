...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_65_with_macro(
    KC_F11,  KC_F12,  KC_GESC, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  _______, KC_BSPC, KC_GRV, \
    KC_F9,   KC_F10,  KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_DEL, \
    KC_F5,   KC_F6,   KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_END, \
    KC_F3,   KC_F4,   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   _______, \
    KC_F1,   KC_F2,   KC_LCTL, KC_LGUI, KC_LALT, MO(_FN1),KC_SPC,           KC_SPC,  _______, MO(_FN2),KC_RCTL, _______, KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_FN2] = LAYOUT_65_with_macro(
    _______, _______, KC_TILD, KC_F13,  KC_F14,  KC_F15,  KC_F16,  KC_F17,  KC_F18,  KC_VOLD, KC_VOLU, KC_MPLY, KC_MSTP,  KC_F23,  KC_F24,  KC_DEL,  KC_BSPC, _______, \
    _______, _______, RGB_TOG, RGB_MOD, _______, KC_UP,   _______, _______, KC_MPRV, KC_MNXT, KC_MRWD, KC_MFFD, _______, _______, _______, _______, _______, \
    _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
